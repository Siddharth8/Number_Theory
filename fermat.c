/*=============================================================================
This is an implementation of Fermat's algorithm to check whether a number is
prime or not. The Fermat primality test is a probabilistic test to determine
if a number is probable prime.
=============================================================================*/
/******************************************************************************
